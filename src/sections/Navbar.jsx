        ...
        <>
            ...
            <div className="lg:hidden bg-white shadow-sm w-full fixed top-0 left-0 z-30 flex items-center px-4 h-16">
                ...
                <div className="flex-1 flex justify-center">
                    <h3 className="font-bold text-xl text-red-600 text-center">Finance Flow</h3>
                </div>
            ...
            >
                ...
                <div className="h-20 flex items-center justify-between px-6 border-b border-gray-100 shrink-0">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="p-2 bg-red-600 rounded-lg shadow-red-200 shadow-sm">
                            <Wallet className="text-white" size={20} />
                        </div>
                        <h1 className="text-xl font-bold text-red-600 ">Finance Tracker</h1>
                    </div>
                ...
                <div className="flex-1 overflow-y-auto py-6 px-4">
                    ...
                    <div className="px-4">
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-2.5 bg-red-600 text-white px-4 py-3.5 rounded-xl shadow-md hover:bg-red-700 transition-all duration-200 hover:shadow-lg active:scale-95 font-medium"
